...
func GetAuthCode(ctx context.Context, c oauth2cli.Config) (string, error) {
...
func receiveCodeViaLocalServer(ctx context.Context, c *oauth2cli.Config) (string, error) {
...
func computeRedirectURL(l net.Listener, c *oauth2cli.Config) string {
